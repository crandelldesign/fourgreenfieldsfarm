...
<div id="slideshow1" class="slideshow carousel slide margin-bottom-15" data-ride="carousel">
	<div class="carousel-inner">
		<div class="item active">
	    	<p><a class="slideshow-link" data-featherlight="image" href="{{url('/')}}/img/photos/haunted1.jpg"><img class="img-responsive center-block" src="{{url('/')}}/img/photos/cropped/haunted1.jpg" /></a></p>
	    </div>
	    <div class="item">
	    	<p><a class="slideshow-link" data-featherlight="image" href="{{url('/')}}/img/photos/haunted2.jpg"><img class="img-responsive center-block" src="{{url('/')}}/img/photos/cropped/haunted2.jpg" /></a></p>
	    </div>
	    <div class="item">
	    	<p><a class="slideshow-link" data-featherlight="image" href="{{url('/')}}/img/photos/haunted3.jpg"><img class="img-responsive center-block" src="{{url('/')}}/img/photos/cropped/haunted3.jpg" /></a></p>
	    </div>
	    <div class="item">
	    	<p><a class="slideshow-link" data-featherlight="image" href="{{url('/')}}/img/photos/haunted4.jpg"><img class="img-responsive center-block" src="{{url('/')}}/img/photos/cropped/haunted4.jpg" /></a></p>
	    </div>
	    <div class="item">
	    	<p><a class="slideshow-link" data-featherlight="image" href="{{url('/')}}/img/photos/haunted5.jpg"><img class="img-responsive center-block" src="{{url('/')}}/img/photos/cropped/haunted5.jpg" /></a></p>
	    </div>
	</div>
</div>
