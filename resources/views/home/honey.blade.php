...
<h1>Bees and Honey</h1>
    ...
    <div class="text-center img-group">
        <a class="thumbnail-popup" href="{{url('/')}}/img/photos/honey7.jpg"><img class="img-responsive center-block" src="{{url('/')}}/img/photos/honey7.jpg"></a>
    ...
    <div class="row">
	    <div class="col-xs-6">
	        <div class="text-center img-group">
	            <a class="thumbnail-popup" href="{{url('/')}}/img/photos/honey8.jpg"><img class="img-responsive center-block" src="{{url('/')}}/img/photos/honey8.jpg"></a>
	            <div class="caption">Four frame hand operated extractor</div>
	        </div>	    </div>
	    <div class="col-xs-6">
	        <div class="text-center img-group">
	            <a class="thumbnail-popup" href="{{url('/')}}/img/photos/honey9.jpg"><img class="img-responsive center-block" src="{{url('/')}}/img/photos/honey9.jpg"></a>
    ...
    <div class="row">
	    <div class="col-xs-6">
	        <div class="text-center img-group">
	            <a class="thumbnail-popup" href="{{url('/')}}/img/photos/honey10.jpg"><img class="img-responsive center-block" src="{{url('/')}}/img/photos/honey10.jpg"></a>
	            <div class="caption">Pure honey being bottled for sale</div>
	        </div>
	    </div>
	    <div class="col-xs-6">
	        <div class="text-center img-group">
	            <a class="thumbnail-popup" href="{{url('/')}}/img/photos/honey11.jpg"><img class="img-responsive center-block" src="{{url('/')}}/img/photos/honey11.jpg"></a>
