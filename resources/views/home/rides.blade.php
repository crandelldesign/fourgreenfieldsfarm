...
<div id="slideshow1" class="slideshow carousel slide margin-bottom-15" data-ride="carousel">
	<div class="carousel-inner">
		<div class="item active">
	    	<a class="slideshow-link thumbnail-popup" href="{{url('/')}}/img/photos/heysleigh1.jpg"><img class="img-responsive center-block" src="{{url('/')}}/img/photos/cropped/heysleigh1.jpg" /></a>
	    </div>
		<div class="item">
	    	<a class="slideshow-link thumbnail-popup" href="{{url('/')}}/img/photos/heysleigh2.jpg"><img class="img-responsive center-block" src="{{url('/')}}/img/photos/heysleigh2.jpg" /></a>
	    </div>
	    <div class="item">
	    ...
	    <div class="item">
			<a class="slideshow-link thumbnail-popup" href="{{url('/')}}/img/photos/heysleigh4.jpg"><img class="img-responsive center-block" src="{{url('/')}}/img/photos/heysleigh4.jpg" /></a>
	    </div>
	    <div class="item">
			<a class="slideshow-link thumbnail-popup" href="{{url('/')}}/img/photos/heysleigh5.jpg"><img class="img-responsive center-block" src="{{url('/')}}/img/photos/cropped/heysleigh5.jpg" /></a>
	    </div>
	    <div class="item">
			<a class="slideshow-link thumbnail-popup" href="{{url('/')}}/img/photos/heysleigh6.jpg"><img class="img-responsive center-block" src="{{url('/')}}/img/photos/heysleigh6.jpg" /></a>
	    </div>
	    <div class="item">
			<a class="slideshow-link thumbnail-popup" href="{{url('/')}}/img/photos/heysleigh7.jpg"><img class="img-responsive center-block" src="{{url('/')}}/img/photos/heysleigh7.jpg" /></a>
	    </div>
	    <div class="item">
			<a class="slideshow-link thumbnail-popup" href="{{url('/')}}/img/photos/heysleigh8.jpg"><img class="img-responsive center-block" src="{{url('/')}}/img/photos/cropped/heysleigh8.jpg" /></a>
	    </div>
	    <!--<div class="item">
	    ...
	    <div class="item">
			<a class="slideshow-link thumbnail-popup" href="{{url('/')}}/img/photos/heysleigh11.jpg"><img class="img-responsive center-block" src="{{url('/')}}/img/photos/cropped/heysleigh11.jpg" /></a>
	    </div>
	    <div class="item">
			<a class="slideshow-link thumbnail-popup" href="{{url('/')}}/img/photos/heysleigh12.jpg"><img class="img-responsive center-block" src="{{url('/')}}/img/photos/cropped/heysleigh12.jpg" /></a>
	    </div>
	    <div class="item">
			<a class="slideshow-link thumbnail-popup" href="{{url('/')}}/img/photos/heysleigh13.jpg"><img class="img-responsive center-block" src="{{url('/')}}/img/photos/cropped/heysleigh13.jpg" /></a>
	    </div>
	    <!--<div class="item">
	    ...
	    <div class="item">
			<a class="slideshow-link thumbnail-popup" href="{{url('/')}}/img/photos/heysleigh15.jpg"><img class="img-responsive center-block" src="{{url('/')}}/img/photos/cropped/heysleigh15.jpg" /></a>
	    </div>
	    <div class="item">
			<a class="slideshow-link thumbnail-popup" href="{{url('/')}}/img/photos/heysleigh16.jpg"><img class="img-responsive center-block" src="{{url('/')}}/img/photos/cropped/heysleigh16.jpg" /></a>
	    </div>
	    <div class="item">
			<a class="slideshow-link thumbnail-popup" href="{{url('/')}}/img/photos/heysleigh17.jpg"><img class="img-responsive center-block" src="{{url('/')}}/img/photos/cropped/heysleigh17.jpg" /></a>
	    </div>
	    <div class="item">
			<a class="slideshow-link thumbnail-popup" href="{{url('/')}}/img/photos/heysleigh18.jpg"><img class="img-responsive center-block" src="{{url('/')}}/img/photos/cropped/heysleigh18.jpg" /></a>
	    </div>
	    <!--<div class="item">
	    ...
	    <div class="item">
			<a class="slideshow-link thumbnail-popup" href="{{url('/')}}/img/photos/heysleigh20.jpg"><img class="img-responsive center-block" src="{{url('/')}}/img/photos/cropped/heysleigh20.jpg" /></a>
	    </div>
	    <!--<div class="item">
	    ...
	    <div class="item">
			<a class="slideshow-link thumbnail-popup" href="{{url('/')}}/img/photos/heysleigh23.jpg"><img class="img-responsive center-block" src="{{url('/')}}/img/photos/cropped/heysleigh23.jpg" /></a>
	    </div>
	    <div class="item">
			<a class="slideshow-link thumbnail-popup" href="{{url('/')}}/img/photos/heysleigh24.jpg"><img class="img-responsive center-block" src="{{url('/')}}/img/photos/cropped/heysleigh24.jpg" /></a>
	    </div>
	    <div class="item">
			<a class="slideshow-link thumbnail-popup" href="{{url('/')}}/img/photos/heysleigh25.jpg"><img class="img-responsive center-block" src="{{url('/')}}/img/photos/cropped/heysleigh25.jpg" /></a>
	    </div>
	    <div class="item">
			<a class="slideshow-link thumbnail-popup" href="{{url('/')}}/img/photos/heysleigh26.jpg"><img class="img-responsive center-block" src="{{url('/')}}/img/photos/cropped/heysleigh26.jpg" /></a>
	    </div>
	    <div class="item">
			<a class="slideshow-link thumbnail-popup" href="{{url('/')}}/img/photos/heysleigh27.jpg"><img class="img-responsive center-block" src="{{url('/')}}/img/photos/cropped/heysleigh27.jpg" /></a>
	    </div>
	</div>
</div>

<div class="pull-left margin-right-15 margin-bottom-15 img-group img-aside-sm">
	<a class="ride1" class="thumbnail-popup" href="{{url('/')}}/img/photos/rides1.jpg"><img class="img-responsive center-block" src="{{url('/')}}/img/photos/cropped/rides1.jpg" alt="Rides" /></a>
</div>
...
<div class="pull-left margin-right-15 margin-bottom-15 img-group img-aside-sm">
	<p><a class="ride3" class="thumbnail-popup" href="{{url('/')}}/img/photos/rides3.jpg"><img class="img-responsive center-block" src="{{url('/')}}/img/photos/cropped/rides3.jpg" alt="Rides" /></a></p>
