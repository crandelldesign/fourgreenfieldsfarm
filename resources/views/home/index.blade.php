...
<div class="row hours-prices">
    <div class="col-sm-6 col-md-5">
        <h3>Corn Maze</h3>
        <p>September 26 to November 1</p>
        <h4>Hours</h4>
        <table class="table">
            <tr>
                <th>Saturday</th>
