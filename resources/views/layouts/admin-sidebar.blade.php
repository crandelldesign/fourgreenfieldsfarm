...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{(isset($active_page)) && ($active_page == 'add-event')?'active':''}}"><a href="{{url('/admin/events/add')}}">Add an Event</a></li>
            <li class="{{(isset($active_page)) && ($active_page == 'edit-event')?'active':''}}"><a href="{{url('/admin/events')}}">Edit Events</a></li>
